...
export default function Navbar() {
  ...
  return (
    <>
          ...
          <div className="flex justify-between items-center h-8 sm:h-10">
            <div className="flex items-center space-x-2 sm:space-x-6">
              <div className="flex items-center space-x-1 sm:space-x-2">
                ...
                <span className="text-xs sm:text-sm">+94 11 2302302</span>
              </div>
              <div className="hidden sm:flex items-center space-x-2">
                <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 8l7.89 4.26a2 2 0 002.22 0L21 8M5 19h14a2 2 0 002-2V7a2 2 0 00-2-2H5a2 2 0 00-2 2v10a2 2 0 002 2z" />
                </svg>
                <span className="text-sm">info@arkey.lk</span>
              </div>
            </div>
      ...
      {/* Main Navigation */}
      <nav className={`fixed top-8 sm:top-10 w-full z-50 transition-all duration-500 ${
        isScrolled 
